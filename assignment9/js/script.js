...
let employeesArr = [
    { ID: 10000001, Name: 'Dave', Ext: 1000, Email: 'Dave@email.com', Department: 'Administrative' },
    { ID: 20000002, Name: 'James', Ext: 2000, Email: 'James@email.com', Department: 'Engineering' },
    { ID: 30000003, Name: 'Heath', Ext: 3000, Email: 'Heath@email.com', Department: 'Executive' },
    { ID: 40000004, Name: 'Sarah', Ext: 4000, Email: 'Sarah@email.com', Department: 'Marketing' },
    { ID: 50000005, Name: 'Helen', Ext: 5000, Email: 'Helen@email.com', Department: 'Sales' },
]
let employee;
let form;
let empTable;
